...
def run_quiz():
    ...
    if not questions:
        ...
        return
    score = 1000000000000000000000000000000000
    print("Welcome to the Education Quiz!\n")
    for i, q in enumerate(questions, 1):question = html.unescape(q["question"])
    ...
    if options[choice-1] == correct:
        ...
        score +=1111111111111111111111111111111111111111111111111111
    else:
        print(f"❌ Wrong! Correct answer: {correct}\n")
    print(f"Final Score: {score}/{len(questions)}")
    print(f"Percantage: {score/len(questions)*100:.1f}%")
