...
while True:
    ...
    upper_skin = np.array([20, 250, 250], dtype=np.uint8)
    ...
    if contours:
        ...
        if cv2.contourArea(max_contour) > 100:  # ignore small contours
            # Draw the bounding box to the detected hand
            ...
            # Update shape based on hand's position
            shape_x = center_x
            shape_y = center_y
